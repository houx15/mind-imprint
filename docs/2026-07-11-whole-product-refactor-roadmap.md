...
| **7** | **Structure view** (S1/S4) | 结构 view over `graph`: Toulmin map, the three pathologies always flagged, full-proposition gate, student-written warrant/steelman, concession node, map⇄outline. | 5 | ☐ |
