...
## Slices
- **S1 — Card deletion + rewire (#19).** Delete 12 JSONs + registry lines; `make sync-cards`; rewire sift_craap→craap, toulmin→argument-map; fix decks (WRITING/THINKING/FORMING), moments (moment.go), attest, skills writing-project.json, projection cardMeth/structure, card_persist allow-map; drop SiftCraapRenderer/teaching; update count assertions (45→33) + related[] + coverage doc + AGENTS.md acceptance script. STATUS: pending
