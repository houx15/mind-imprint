...
func (a *API) Handler() http.Handler {
	...
	mux.Handle("PATCH /api/v1/projects/{id}", protected(a.renameProject))
	...
	mux.Handle("POST /api/v1/projects/{id}/references/{rid}/ingest-file", protected(a.ingestReferenceFile))
