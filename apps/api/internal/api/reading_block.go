...
var readingShapedSuffix = map[string]string{
	...
	"grammar": "\n\n只输出一个 JSON 对象：" +
		...
		"【词法】\n" +
		"- words：这一句里值得单独学的**关键词或词组**，2 到 4 个。挑的是词性、词形或用法特别的" +
		...
		"【时态】\n" +
		"- tenses：这一句里**值得说**的谓语时态，0 到 3 条，**从句里的谓语也算**（过去完成时、现在完成时、" +
		"被动语态、情态动词最值得说）。只有一般现在时陈述事实就给空数组。\n" +
