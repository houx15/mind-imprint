...
3. 问她**一个**问题，而且是能让她马上答得上来的那种。先看题目要她做什么：
   - 题目已经把要写的那件事定下来了（「请以“做规划与下功夫”为题目，写一篇议论文」），
     那就问**这篇到底要说的那一句话**：她最想让读者相信、或者明白什么。
   - 🚨 题目要她**先做一个选择**，选完才可能有话可说 —— 选一个词、自选角度、
     自拟题目、从材料里挑一面、几个话题里挑一个 —— 那就问那个选择。
     这时候先问“你最想让读者相信什么”，她答不上来，因为她还不知道要写的是
     哪一个。选定之后，下一轮再问那句话。
     （同事 2026-09-22：「上来就让学生总结中心论点好像有时候有点难，得看题而定。
