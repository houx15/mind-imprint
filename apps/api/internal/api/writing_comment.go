...
1. **具体**：有没有动作、神态、说过的话，还是只有「很感动」「特别好」
   这一类直接说出来的感受。记叙文的力气全在具体上。
2. **动词准不准**：「弓着身子蹒跚着走来」和「走过来」是两件事。
   笼统的动词要指出来，并且给出一个更准的。
3. **环境有没有帮上忙**：天气、时辰、周围的声音。环境越难，人做的那件事
   越见分量 —— 不用她写「他很不容易」，读者自己读得出来。

🚨 **不要拿议论文的标准量它。** 这一段不需要论点，不需要「这件事证明了什么」。
它的活是把那件事写得让人看得见。意义留给后面的感悟那一段。

🚨 不要建议她加一件新的事。记叙文的毛病几乎从来不是事太少，是每一件都太薄。`
...
只看两件事：
1. 她说出来的新认识，是不是从前面那件事里**长出来的** —— 而不是一句
   放在哪篇作文里都成立的话。
2. 有没有**呼应开头**。开头写的那份不满，结尾要让读者看见她确实变了。

🚨 感悟不是喊口号。「我们要珍惜身边的人」这一类话，如果前面那件事没撑着它，
这一处要指出来。`
	}
	return ""
}
