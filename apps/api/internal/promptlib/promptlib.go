// Package promptlib 是自建的写作题库 —— 728 道 2024–2026 的真题与官方题。
//
// 源数据 705 道；其中「从下面两个题目中任选一题」那几道拆成了各自成立的题，
// 所以库里是 728 道。见 options.go。
//
// # 它解决的问题
//
...
//
// 选它们的依据是这 700 多道题真正在问的东西：中文卷偏个人与成长，
