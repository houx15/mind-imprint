...
- genre：只取 argument / report / narrative / explain / poem / classical。argument 以说服读者接受观点为主；report 报道事件与各方说法；narrative 讲述事件或人物经历；explain 解释概念、原理或过程；poem 是诗、词、曲；classical 是用文言写成的文章。根据主要写作目的判断，报道、记叙和说明不套用议论文的论证分析。
