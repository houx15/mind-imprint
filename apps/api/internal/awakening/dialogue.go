...
const dialogueSystemHead = prompts.AwakeningDialogueSystemHead

const dialogueSystemRulesHead = prompts.AwakeningDialogueSystemRulesHead

const dialogueSystemRulesTail = prompts.AwakeningDialogueSystemRulesTail
