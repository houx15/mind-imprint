...
var Nodes = []Node{
	{
		Code:      "NODE 01 / SPARK",
		Objective: "从学生最近的真实经历里，了解学生想继续关注的兴趣对象。",
	...
	},
	{
		...
		Ask:       "这件事里，哪一个具体细节最吸引你？可以是一个画面、人物、规则或尚未解释的问题。",
		MinRunes:  8,
		Retry:     "不用概括整个主题。回到一个最具体的瞬间：哪个画面、人物、规则、句子或冲突让你停了下来？",
	},
	{
		Code:      "NODE 03 / CONNECT",
		Objective: "把这个细节连回学生自己的经历、感受或学生身边正在发生的事。",
	...
	},
	{
		...
		Objective: "找到一处学生想不通、感到意外，或者知道有争议的地方。这是后面那个研究问题的来源。",
		Ask:       "关于它，哪一点最让你想不通、感到意外，或者你觉得大家可能有不同看法？",
		MinRunes:  8,
		Retry:     "关于这件事，有没有一种你听过、还想进一步了解或讨论的看法？",
	},
	{
		...
		MinRunes:  8,
		Retry:     "先把你的困惑写成一句「为什么……」或者「在什么条件下……」。请明确你想了解的对象和问题。",
	},
	{
		Code:      "NODE 06 / READ",
		...
		MinRunes:  6,
		Retry:     "想象你要向同学解释这个问题：哪一点还需要查阅材料才能解释清楚？那一点就是第一类要读的内容。",
	},
	{
		Code:      "NODE 07 / THINK",
		...
		MinRunes:  8,
		Retry:     "先用「我目前猜测……因为……」说一句，再补一句「如果看到……我会修改想法」。暂定回答可以在查阅材料后调整。",
	},
	{
		Code:      "NODE 08 / CREATE",
		Objective: "把探究变成一件面向真实读者的作品设想。",
		Ask:       "如果把探索结果做成一件作品，你最想让谁看到？你想让对方理解什么，或者开始讨论什么？文章、视频、播客、图解、展览都可以。",
		MinRunes:  8,
