...
const selectionRules = prompts.AwakeningSelectionRules

const selectionPromptTail = prompts.AwakeningSelectionPromptTail

const selectionPromptHead = prompts.AwakeningSelectionPromptHead
