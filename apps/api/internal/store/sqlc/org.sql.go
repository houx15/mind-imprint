...
SELECT id, email, email_verified_at, password_hash, role, school_id, display_name, avatar_color, created_at, card_theme, page_background, onboarded_at, gender FROM users WHERE id = $1 AND school_id = $2
`
