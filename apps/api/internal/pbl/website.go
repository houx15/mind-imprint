...
func WebsiteRoutine() []RoutineStep {
	return []RoutineStep{
		{
			Title:     "想清楚给谁看",
			Blurb:     "一个网站的样子由读它的人决定，所以先把这个人想清楚。",
		...
		},
		{
			...
			IBring:    "三个风格样例，以及你贴进来的每一站的结构分析。",
			YouBring:  "三个你自己找到、真的喜欢的网站。",
			Decide:    "哪些结构值得学，你的结构长什么样。",
...
2. 去看真的个人网站 → sites。
   ...
   是什么、最狠的一处在哪。三张之后，你提一版「他们的共同点」和「哪里可以是他
   独有的」，让他划掉不同意的。
...
5. 逐处审改，然后上线 → review + artifact 一起给。
   marks 里抄的必须是这一页上真有的句子，一字不差。他改完，链接归他。
