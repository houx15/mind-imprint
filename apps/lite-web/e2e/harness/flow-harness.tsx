...
import vocabulary from "../../../../packages/contracts/vocab/methods.json";
...
const STRUCTURES = vocabulary.methods.filter((m) => ["struct_total_part", "struct_parallel", "struct_progressive", "struct_contrast"].includes(m.id)).map((m) => ({ ...m, example: m.examples[0]?.text ?? "" }));
