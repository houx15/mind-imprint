import { StudentArtwork } from "./StudentArtwork";
...
export function GuestTheme({ children }: { children: ReactNode }) {
  ...
  return <AccentProvider initialAccent="teal" presets={LITE_ACCENT_PRESETS}><StudentArtwork><CompanionAppearanceProvider image={bookmark}><div className="lite-student student-guest h-full min-h-full bg-mk-paper text-mk-ink" style={style}>{children}</div></CompanionAppearanceProvider></StudentArtwork></AccentProvider>;
}
