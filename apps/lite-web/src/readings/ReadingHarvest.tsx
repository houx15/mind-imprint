 ...
 *
 *   我摘抄的  她在正文里划选后按「摘抄」留下的句子（2026-09-22）
 ...
 * 点那一句旁边的「和印记说」—— 那一句进印记那一栏的输入框，下一句话由她写。
 */
...
export function ReadingHarvest({
  ...
  if (empty) {
    ...
    return (
      <p className="mk-harvest__empty">
        这里会留下你读这篇时的成果：摘抄的句子、学过的词、拆开的句子、摆过的板，以及你写下的话。
      </p>
    );
  }
  ...
  return (
    <div className="mk-harvest">
      {excerpts.length > 0 && (
        <Section title="我摘抄的" hint="句子是文章的原话，挑出它的是你。">
          {excerpts.map((e) => {
