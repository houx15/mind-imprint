...
const reading: LiteReport = {
  ...
  turningPoints: [
    {
      turn: 4,
      why: "她在这里把「装机量」和「排放」分成了两个问题",
      student: "等一下，装机量第一说的是建了多少，排放说的是烧了多少。这两个数字不是一回事吧？",
      coach: "对，这是两件事。那你觉得哪一个更能回答「这个国家做得怎么样」？",
    },
    {
      turn: 9,
      why: "印记指出她把记者的推算当成了数据本身，她接住了",
      student: "我刚才想引用那句「比世界其他地方加起来还多」，但这句话后面没有标出处。",
      coach: "你注意到了这一点很关键。那句话有出处，在 IEA 的年度报告里 —— 但你要自己去核一遍，而不是信记者的转述。",
    },
  ],
  article: {
    sourceUrl: "https://www.nature.com/articles/d41586-026-01234-5",
    host: "nature.com",
    excerpt:
      "中国在 2025 年新增的太阳能装机容量，超过了世界其他地区的总和。但在同一年，煤炭仍然贡献了这个国家一半以上的发电量——两个事实同时成立。",
  },
  prosePending: false,
};
