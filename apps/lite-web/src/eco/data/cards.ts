...
export const CARDS: Record<string, CardSpec> = {
  ...
  keywords: {
    ...
    kind: "frame",
    surface: "chat",
    reason: "在你去看别人的东西之前，先把你现在想要的效果写下来。看完十个再回来对一次。",
    teaches:
  ...
  persona: {
    ...
    teaches:
      "为「所有人」做的东西，最后谁都不合用。给一个具体的人做，很多决定就有了依据——字要多大、话要多正式、哪一段可以删。",
    payoff:
  ...
  inventory: {
    ...
    payoff:
      "你手上真的有什么，决定了这一页能做成什么样。这一栏填完，我拟内容草稿的时候就不会再编——你的库里没有的东西我不会替你写上去。",
    glyph: "▥",
    hue: "var(--mk-matcha)",
    minutes: 20,
    fields: [
