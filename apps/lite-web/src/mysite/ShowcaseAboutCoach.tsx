...
export function ShowcaseAboutCoach({draft, available, disabled, onBusy, onConversation, onApply}: {
  ...
  useEffect(() => { const el = conversation.current; if (el) el.scrollTop = el.scrollHeight; }, [messages.length, pending, proposal]);
  async function send() {
  ...
  return <section className="showcase-about-coach" aria-label="讨论个人介绍">
    <div ref={conversation} className="showcase-coach-conversation" aria-live="polite">
    ...
    <div className="showcase-coach-composer">
