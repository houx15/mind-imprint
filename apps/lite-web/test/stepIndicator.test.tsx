 ...
 *
 * (Restored 2026-08-30 after the dial briefly replaced it.) It fills the slot
 * lite's forked room left empty where pro still carries
...
describe("StepIndicator", () => {
  it("names where she is: 第 N 步 / 共 M 步 plus the step's own label", () => {
    ...
    // The steps she is not on are the dial's job, not this row's.
  ...
  it("is visible on a narrow screen — it is the FIRST step surface there", () => {
    // The dial beside it folds to a 54px disc, so on a narrow screen this row
    // is the only place the current step is legible WITHOUT a tap. A
    // responsive-hiding utility anywhere in this subtree would take that away.
