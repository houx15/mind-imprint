...
describe("resolveReferences", () => {
  ...
  it("always marks annotation refs as missing (no annotation entity yet)", () => {
  ...
  it("marks a dangling id as missing regardless of kind", () => {
    ...
    const resolved = resolveReferences(refs, [makeReference()], [{ id: "snip-1", text: "x", position: 0, section: null }]);
